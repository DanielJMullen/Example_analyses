...
Please consult the TCGA_dataset_downloader script for information on how to 
acquire the example datasets used in this tutorial. 

```{r}
## Replace the path to the .rda here with the location you  downloaded the .rda to on your system (that should be the path you set for the TENET_directory argument). 
